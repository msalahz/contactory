/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b3b47258fec31faf75d820a94b44ca8c)
...
declare namespace Cloudflare {
  interface Env {
    ...
    BETTER_AUTH_ENABLE_OPENAPI: string
    BETTER_AUTH_USE_SECURE_COOKIES: string
    ...
    VITE_BETTER_AUTH_CALLBACK_URL: string
    CONTACTORY_R2_BUCKET: R2Bucket
